# Real-data dry-run — 2026-09-21

**Verdict: SAFE TO CUT OVER** — 1 item needs your decision (Sheet bugs / conventions); none blocks the platform

Source: live Sheet 1pSVrpDwiN6Ja2RfwVbsxj4H6J3eBRtnLtKNc1TGtoMk → accommerce_dryrun_test · today = 2026-09-21
...
| R2 — SOH by day (StockModel — Stock) | 588 | 0 | 0 |
