...
|---|---:|---:|---:|
| R1 — SOH today per SKU/warehouse (Inventory Ledger — Current On-Hand) | 2 | 1 | 1 |
| R2 — SOH by day (StockModel — Stock) | 0 | 0 | 0 |
| R3 — Daily COGS (Opening Qty/Value, Units Sold, COGS, Unpriced) | 0 | 0 | 0 |
| R4 — Landed cost per shipment line (Landed Cost Summary, net of EUST/VAT) | 0 | 1 | 1 |
| R5 — Payments per PO and per shipment (slots, amounts, paid flags, dates) | 0 | 0 | 0 |
| R6 — Transactions (count, EUR total, transferred matches) | 0 | 0 | 0 |
| R7 — Sales actuals per SKU/warehouse (totals) | 0 | 0 | 0 |
...
Migration: 0 paid payments transferred, 0 transaction links transferred, 0 rows quarantined, 0 links not transferable, 0 export issues.
...
|---|---:|---:|---:|---|---|
| Mixer/Mutual (migration gate — rolled back) | 1003 | 403 | -600 | unclassified |  |
...
| Key | Sheet | Platform | Diff | Class | Note |
|---|---:|---:|---:|---|---|
| Mutual-PO2-Delivered Mixer / Mixer (migration gate — rolled back) | 0 | — | — | unclassified |  |
