# Real-data dry-run — 2026-09-23

**Verdict: SAFE TO CUT OVER** — 1 item needs your decision (Sheet bugs / conventions); none blocks the platform

Source: live Sheet 1pSVrpDwiN6Ja2RfwVbsxj4H6J3eBRtnLtKNc1TGtoMk → accommerce_dryrun · today = 2026-09-23
...
| R2 — SOH by day (StockModel — Stock) | 600 | 0 | 0 |
| R3 — Daily COGS (Opening Qty/Value, Units Sold, COGS, Unpriced) | 588 | 0 | 0 |
