# Real-data dry-run — 2026-09-22

**Verdict: SAFE TO CUT OVER** — 1 item needs your decision (Sheet bugs / conventions); none blocks the platform

Source: live Sheet 1pSVrpDwiN6Ja2RfwVbsxj4H6J3eBRtnLtKNc1TGtoMk → accommerce_dryrun · today = 2026-09-22
...
| R2 — SOH by day (StockModel — Stock) | 594 | 0 | 0 |
| R3 — Daily COGS (Opening Qty/Value, Units Sold, COGS, Unpriced) | 582 | 0 | 0 |
...
- Rows named <prefix>Container<N>-<SKU> are the lines of one physical container and merge into one pooled shipment; its freight/duty shares are the Sheet's own per-row split, its payment slots are the rows' slots summed.
